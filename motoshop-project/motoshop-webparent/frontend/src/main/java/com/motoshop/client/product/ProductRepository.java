...
public interface ProductRepository extends PagingAndSortingRepository<Product, Integer> {
	...
	/*
	 * câu SQL tương ứng sẽ là: ALTER TABLE `shoppingcart`.`products` ADD FULLTEXT
	 * INDEX `products_FTS` (`name`, `short_description`, `full_description`);
	 */

	// Full Text Search giúp tìm kiếm nhanh chóng và hiệu quả
	// Full Text Search được sử dụng khi tìm kiếm trên nhiều cột và dữ liệu tìm kiếm
	// lớn
