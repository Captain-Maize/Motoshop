...
public class SettingService {//class này chứa tất cả các settings
	...
	('MAIL_FROM','huyngonhat414@gmail.com','MAIL_SERVER'),
	('MAIL_HOST','smtp.gmail.com','MAIL_SERVER'),
	('MAIL_PASSWORD','ucmyvnwltqdzikuj','MAIL_SERVER'),
	('MAIL_PORT','587','MAIL_SERVER'),
	('MAIL_SENDER_NAME','Shopping Team','MAIL_SERVER'),
	('MAIL_USERNAME','huyngonhat414@gmail.com','MAIL_SERVER'),
	...
	*/
	...
	MAIL_PORT			587						MAIL_SERVER
	MAIL_USERNAME		huyngonhat414@gmail.com	MAIL_SERVER				
	MAIL_PASSWORD		awfifcehbvugmdlj		MAIL_SERVER
	MAIL_FROM			huyngonhat414@gmail.com	MAIL_SERVER
	SMTP_AUTH			true					MAIL_SERVER
	SMTP_SECURED		true					MAIL_SERVER
	MAIL_SENDER_NAME	Moto Shop Team			MAIL_SERVER	
	...
	2/ Đăng nhập đường dẫn: https://myaccount.google.com/apppasswords > nhập email và password > Select app(chọn ứng dụng), chọn Other(khác) > nhập Shopping Cart > Tạo > copy mã(ucmyvnwltqdzikuj)
